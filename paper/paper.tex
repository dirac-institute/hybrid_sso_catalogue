...
Our paper is structured as follows. In Section~\ref{sec:method}, we describe the methods for creating a hybrid catalogue of objects, simulating LSST observations and calculating \dig{} scores for the NEOCP. \todo{Outline rest of paper} \placeholder{2}
